...
> This is a copy of the root [`ARCHITECTURE.md`](../ARCHITECTURE.md), kept here
> because the build plan places architecture documentation under `docs/`. The
> root file is canonical; if these ever differ, that is a bug.
